...
svm_parser.add_argument('-l', '--learning_rate', default=0.01, type=float, help='The learning rate')
svm_parser.add_argument('-e', '--epochs', default=12, type=int, help='The number of epochs to train for')
