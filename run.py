...
svm_parser.add_argument('-l', '--learning_rate', default=0.005, type=float, help='The learning rate')
svm_parser.add_argument('-e', '--epochs', default=16, type=int, help='The number of epochs to train for')
